...
export const SupportChatPanel: React.FC<{
  ...
  const { messages, sendMessage, isLoading, error, stopGenerating, isStreaming } = useChatMessages({
    ...
    prompt:
      "Introduce yourself as an AI support agent and briefly outline your main functions using emojis. Make sure to mention that you can help open a Zendesk ticket with the Ailiv Support team.",
    agentParams: {
      email: user.email,

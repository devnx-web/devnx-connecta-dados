...
const messages = {
  "cloud.adpOrganization.banner": "This is an Ailiv Agents organization. <lnk>Manage it on app.airbyte.ai</lnk>.",
};
...
describe("AdpOrganizationBanner", () => {
  ...
  it("should render banner when organization is ADP", () => {
    ...
    expect(screen.getByText(/This is an Ailiv Agents organization/)).toBeInTheDocument();
  });

...
O proxy `/api/` do frontend deve apontar para o host Docker (`http://host.docker.internal:8002`) e preservar a URI original; nao use `proxy_pass .../api/`, pois isso remove `/v1/...` das chamadas do Airbyte.
